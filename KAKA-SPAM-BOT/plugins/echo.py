...
from KAKA-SPAM-BOT import Riz, Riz2, Riz3, Riz4, Riz5 , Riz6, Riz7, Riz8, Riz9, Riz10, SUDO_USERS, OWNER_ID

from KAKA-SPAM-BOT import CMD_HNDLR as hl
from KAKA-SPAM-BOT.sql.echo_sql import addecho, get_all_echos, is_echo, remove_echo
